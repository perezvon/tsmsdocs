  ...
  render() {
    return (
      <Container className="user-links">
        <UserIcon href='https://github.com/perezvon'>
          <FaGithubAlt style={iconStyle} />
        </UserIcon>
        <UserIcon href='https://twitter.com/itsjohnamaloney'>
          <FaTwitter style={iconStyle} />
        </UserIcon>
        <UserIcon href="https://www.messenger.com/t/jmaloney518">
          <MdMessage style={iconStyle} />
        </UserIcon>
        <UserIcon href="mailto:john.a.maloney@gmail.com">
